...
AddListener("class_change", 0, function (player, params)
{
    ...
    {
        //Apply the class change without respawning the player, so switching
        //classes during setup can't be used to trigger a death/respawn loop.
        //The player stays dead; the new class takes effect on their next real spawn.
